...
const services = [
  ...
  {
    serviceLink: "Callender",
    iconClass: "material-symbols-outlined ",
    iconName: "calendar_month",
    serviceName: "Callender",
  },
  // {
  //   iconClass: "",
  //   iconName: "",
    ...
    <>
      ...
      <section className="flex flex-row justify-between flex-wrap w-[95vw] md:w-[80vw] bg-gray-800 m-auto rounded-xl my-[3vh] p-6 md:p-8">
        {services.map((service, index) => (
          <a key={index} className="text-white bg-gray-700 p-5 w-[35vw] flex flex-col  md:justify-evenly items-center gap-3 rounded-2xl md:gap-5 my-2 cursor-pointer" >
            <span
            ...
            <div className="text-white text-xl md:text-3xl text-center">{service.serviceName}</div>
          </a>
        ))}
      </section>
