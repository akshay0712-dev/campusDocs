...
const aYearaSem = ({ semester }) => {
  return (
    <>
      {/* <div className="text-center text-2xl">{semester}</div> */}
      <div className="w-[95vw] md:w-[80vw] mx-auto bgleft my-2 rounded-xl md:rounded-2xl overflow-hidden">
        ...
        {semester == 0 ?  subjects[semester].subj.map((sub, i1) => (
          <div
            key={i1}
        ...
        )) : <h1 className="text-center text-white text-base md:text-xl py-6">{`The syllabus for Semester ${semester+1} will be made available shortly.`}</h1>}
